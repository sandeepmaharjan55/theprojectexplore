/* Simple Analytics - Privacy friendly analytics (docs.simpleanalytics.com/script; 2021-04-20; f9eb; v7) */
...
!(function (u, e, t, n) {
  try {
    ...
    var p = "https:",
      ...
      B = "platform",
      C = "platformVersion",
      H = /(bot|spider|crawl)/i.test(c) && !/(cubot)/i.test(c),
      R = u.screen,
      k =
        l.webdriver ||
        u.__nightmare ||
        ...
        "phantom" in u ||
        H,
      I = { version: "custom_latest_7", ua: c };
    k && (I.bot = !0),
      (I.sri = !0),
    ...
    var oe,
      ...
      le = "(utm_)?",
      fe = {
        source: z(le + "source|ref"),
        medium: z(le + "medium"),
        campaign: z(le + "campaign"),
        term: z(le + "term"),
        content: z(le + "content"),
        referrer: pe,
      },
      he = 0,
      de = "sendBeacon",
      ge = function (e, t) {
        ...
        (n.duration = Math.round((V() - Y - he) / 1e3)),
          ...
          !t && de in l ? l[de](_ + "/append", y(U(I, n))) : L(n);
      };
    u.addEventListener(
      "visibilitychange",
      function () {
        d.hidden ? ("on" + q in u || ge(), (ce = V())) : (he += V() - ce);
      },
      !1
    ),
      w(q, ge, !1);
      ...
      we = function (e, t) {
        ...
        if (n && oe != n) {
          var r = {
            ...
            viewport_height: Math.max(E[$] || 0, u.innerHeight || 0) || null,
          };
          l[x] && (r[x] = l[x]),
            R && ((r.screen_width = R.width), (r.screen_height = R.height));
          var i = u.performance,
            a = "navigation",
            o =
              i &&
            ...
            c = !!pe && d.referrer.split("/")[2] == h;
          (r.unique = !e && !o && !c), (se = r);
          var s = function () {
            (g = !0),
              (function (e, t, n) {
                e && ge("" + ue, !0), (ue = j()), (se.id = ue);
                var r = te + ye();
                L(
                  U(se, t ? { referrer: n ? pe : null } : fe, {
                    https: f.protocol == p,
                    timezone: F,
                    type: "pageview",
                  })
    ...
    var Ee = j(),
      ...
      Oe = function (e, t) {
        var n = N(e),
          r = N(t) ? t : function () {};
        if (xe.indexOf(typeof e) < 0 && !n)
          return P("event is not a string: " + e), r();
        try {
          if (n && ((e = e()), xe.indexOf(typeof e) < 0))
    ...
    for (var Te in ((u[re] = Ae), Se))
      Array.isArray(Se[Te]) ? Oe.apply(null, Se[Te]) : Oe(Se[Te]);
  } catch (Be) {
    W(Be);
  }
  var De, $e, qe;
})(window, {}, "sa.nomadlist.com", "sa_event");
