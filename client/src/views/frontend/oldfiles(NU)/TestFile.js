...
//     float: "left",
// };
// const ActionClearSearch = {position:"absolute",
// zIndex:"1",
// fontSize:"0.75em",
// top:"9px",
// right:"10px",
                                    ...
                                    className="tabbar-label">Trips</span></a><a href="/chat" className="tab-link"><i
                                        className="icon f7-icons ios-only">chat<span className="badge color-red">42</span></i><i
                                            className="icon icon-fill f7-icons ios-only">chat_fill<span className="badge color-red">42</span></i><span
                                                className="tabbar-label">Chat</span></a>
                </div>
                {/* top bar for search options */}
                <div className="top-bar" id="top-bar">
    <div className="container">
        <div className="brand tooltip-set" title="">
            <svg xmlns="http://www.w3.org/2000/svg" className="logo" viewBox="0 0 908 907">
        ...
        {/* <div className="search-container" style={TopBarSearchContainer}>*/}
            ...
            <img alt="Clear search" className="action-clear-search" src="/assets/times-circle.svg" />
            <label htmlFor="search" style={{ display: "none" }}>Search: </label><input id="search" autoComplete="off"
                type="text" className="search" placeholder="Search" value="" />
        </div>
        <span className="top-bar-user-avatar-position-for-sign-up"></span>
        ...
        <div className="button reverse red action-sign-up hide-before-800px">Join Nomad List</div><a rel="noopener"
            ...
            style={{ fontWeight: "var(--bold)" }}>Remote Jobs <span className="badge tooltip-set"
                title="">6</span></a>&nbsp; <a rel="noopener follow"
            href="https://www.safetywing.com/?referenceID=24730000&amp;ref=nomadlist" className="nav-item">Nomad
            Insurance</a>&nbsp; <a href="/chat" className="nav-item" rel="noopener">Chat</a>&nbsp; <a href="/meetups"
            title="Remote Worker Meetups" className="nav-item">Meetups</a>&nbsp; <a rel="follow noopener"
            href="https://rebase.to/?ref=nomadlist" title="Rebase Visas &amp; Residency" className="nav-item">Visas
            &amp;
            Residency <span className="badge">New</span></a>&nbsp; <a href="/climate-finder"
            title="Remote Worker Meetups" className="nav-item">Climate Finder</a>&nbsp; <a href="/forum"
            className="nav-item" rel="noopener">Forum</a>&nbsp; <a href="/faq" className="nav-item"
            rel="noopener">FAQ</a>&nbsp; <a href="/dating" title="Digital Nomad Dating" className="nav-item">Dating
            <span className="badge">New</span></a>&nbsp; <a href="/community" title="Remote Work Community"
            className="nav-item">Members</a>&nbsp; <a rel="noopener" target="_blank"
            href="https://remoteok.com/hire-remotely" title="Hire Remotely" alt="Hire Remotely"
            className="nav-item">Hire
            Remotely</a>&nbsp; <img alt="Open menu" src="/assets/three-dots.svg" className="top-bar-three-dots" />
    </div>
                </div>
                <div className="head-image new-user-hero" style={{ backgroundColor: '#3b4a2b', backgroundSize: 'cover', backgroundImage: 'url("https://images.unsplash.com/photo-1608229063899-4fd8fb97969b?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=900&ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTYzOTEyMDMzMw&ixlib=rb-1.2.1&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1600")' }}>
                    <div className="text">
                        ...
                        <div className="box">
                            <div className="action-sign-up intro-video-box">
                                <img alt="Explore the world" className="lazyload" src="https://images.unsplash.com/photo-1608229063899-4fd8fb97969b?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=900&ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTYzOTEyMDMzMw&ixlib=rb-1.2.1&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1600" />
                            </div>
                ...
                <div className="view-container">
                    ...
                    <div className="filter-actions">
                        <div className="brand tooltip-set" title="">
                            <svg alt="Nomad List" className="logo" enableBackground="new 0 0 907.3 906.4"
                    ...
                    <ul className="grid show view">
                        ...
                        <div className="grid-side show">
                            ...
                            <div className="item item-aux show not-a-place ignore-click" data-type="text_with_image">
                                <div data-url="https://safetywing.com/nomad-insurance?referenceID=24730000&utm_source=24736628&utm_medium=Ambassador&ref=nomadlist" className=" container aux">
                                    ...
                                    <div className="text">
                                        <img alt="Global travel medical insurance for $1.34/day! Covid-19 coverage included." src="https://i.picsum.photos/id/0/367/267.jpg?hmac=7vvdjNHaShwe3Ul3DAaQIBBz0RnNLfUcEaCV-94NNLE" width={20} height={20} />{'{'}" "{'}'}
                        ...
                        <li data-type="city" className="item show show-later {slugAsClassName} template" data-i={26} data-slug="{slug}">
                            ...
                            {'{'}/* {'{'}badge{'}'} */{'}'}badge
                            <span className="click " />
                            <img src="./assets/pixel.gif" className="bg lazyload" alt="{bgItemAlt}" data-srcset="{bg-data-srcset}" sizes="25vw, (maxWidth:1000px) 33vw, (maxWidth:600px) 50vw" />
                            <meta />
                            <span className="action">
                ...
                {/* <div className="filters">
                    ...
                    <div className="filter-group half">
                        ...
                        <div id="visa_free_for" className="filter visa_free_for cities tooltip" title="At least 30 days of tourist visa and/or visa on arrival available">
                            <select className="choices" data-filter-target="visa_free_for" style={{ backgroundImage: 'url("https://i.picsum.photos/id/0/367/267.jpg?hmac=7vvdjNHaShwe3Ul3DAaQIBBz0RnNLfUcEaCV-94NNLE")' }}>
                        ...
                        <div className>
                            <div className="filter visa_free_for_partner cities tooltip" title="At least 30 days of tourist visa and/or visa on arrival available">
                                <select className="choices" data-filter-target="visa_free_for_partner" style={{ backgroundImage: 'url("https://i.picsum.photos/id/0/367/267.jpg?hmac=7vvdjNHaShwe3Ul3DAaQIBBz0RnNLfUcEaCV-94NNLE")' }}>
                                    <option value selected>
                        ...
                        <div className>
                            <div className="filter visa_free_for_friend cities tooltip" title="At least 30 days of tourist visa and/or visa on arrival available">
                                <select className="choices" data-filter-target="visa_free_for_friend" style={{ backgroundImage: 'url("https://i.picsum.photos/id/0/367/267.jpg?hmac=7vvdjNHaShwe3Ul3DAaQIBBz0RnNLfUcEaCV-94NNLE")' }}>
                                    <option value selected>
