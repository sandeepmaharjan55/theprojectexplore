...
const DataTableAdvSearch = () => {
  ...
  useState(() => {
    axios
    .get(`${config.baseUrl}/users/artistOrClient/list/client`, {
      method: "GET",
      headers: {
  ...
  const handleNameFilter = e => {
    ...
    let updatedData = []
    const dataToFilter = () => {
      if (searchClientName.length || searchEmail.length) {
        return filteredData
      } else {
        return data
      }
  ...
  const handleEmailFilter = e => {
    ...
    let updatedData = []
    const dataToFilter = () => {
      if (searchEmail.length || searchClientName.length) {
        return filteredData
      } else {
        return data
      }
          ...
          <Row form className='mt-1 mb-50'>
            <Col lg='3' md='6'>
              <FormGroup>
                ...
                <Input id='name' placeholder='' value={searchClientName} onChange={handleNameFilter} />
              </FormGroup>
            </Col>
            <Col lg='3' md='6'>
              <FormGroup>
