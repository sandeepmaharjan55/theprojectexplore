...
import FooterComponent from './nefscuncomponents/footer'
import NavbarComponent from './nefscuncomponents/navbar'
import SidebarComponent from './nefscuncomponents/menu/vertical-menu'
...
export default NefscunUserLayout
